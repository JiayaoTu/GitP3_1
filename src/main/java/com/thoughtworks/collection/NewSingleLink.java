...
public class NewSingleLink implements SingleLink<Integer> {
    ...
    public Integer getHeaderData(){ return  null;}
    public Integer getTailData(){ return  null;}
    public int size(){ return  0;}
    public boolean isEmpty(){ return false;}
    public boolean deleteFirst(){ return  false;}
    public boolean deleteLast(){ return  false;}                //删除尾部元素；
